  ...
  return (
    <div className="pt-10 mt-6 border-t border-gray-300 pb-20 px-6 md:px-12 flex md:flex-row flex-col gap-8 items-center">
        <div className="p-6 rounded-lg md:w-1/2">
            ...
            <button onClick={() => naviagate('/partager-examen')} className="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-all duration-300 ease-in-out">
                Partager un examen
            </button>
        </div>
        <img
