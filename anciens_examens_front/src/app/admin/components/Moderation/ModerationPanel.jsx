...
export default function ModerationPanel() {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      ...
      resolved: { color: 'bg-green-100 text-green-800', label: 'Résolu', icon: CheckCircle },
      dismissed: { color: 'bg-gray-100 text-gray-800', label: 'Rejeté', icon: XCircle }
    };
  ...
  const getTypeBadge = (type) => {
    const badges = {
      user: { color: 'bg-red-100 text-red-800', label: 'Utilisateur', icon: User },
      exam: { color: 'bg-blue-100 text-blue-800', label: 'Examen', icon: FileText },
      comment: { color: 'bg-purple-100 text-purple-800', label: 'Commentaire', icon: MessageSquare }
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">{reports.length} signalements au total</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-gray-600 text-sm">Signalements utilisateurs</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-gray-600 text-sm">Signalements examens</p>
        </div>
      </div>
